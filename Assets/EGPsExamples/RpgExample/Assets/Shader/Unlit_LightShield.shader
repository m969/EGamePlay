	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float clampResult18 = clamp( abs( ( texCoord16.y + -0.5 ) ) , 0.0 , 1.0 );
				float temp_output_25_0 = pow( clampResult18 , _Value );
				float clampResult32 = clamp( pow( ( temp_output_25_0 + temp_output_25_0 ) , 50.0 ) , 0.0 , 1.0 );
				float4 appendResult15 = (float4(tex2DNode1.r , tex2DNode1.g , tex2DNode1.b , ( pow( ( ( pow( ( ( tex2DNode1.r + tex2DNode1.g + tex2DNode1.b ) / 3.0 ) , 5.0 ) * ( tex2DNode1.a * 1.0 ) ) * 5.0 ) , 2.0 ) * clampResult32 )));
...
/*ASEBEGIN
Version=19404
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-784,480;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-608,672;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-752,800;Inherit;False;Property;_Value;Value;1;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;25;-112,560;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;30;112,816;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;31;176,1056;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;50;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;48;624,-384;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;32;544,512;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;27;432,848;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;28;320,528;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;33;912,608;Inherit;True;Simplex2D;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;-13.25;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2EB058382585FD6968EAA91421F727B1028B5387
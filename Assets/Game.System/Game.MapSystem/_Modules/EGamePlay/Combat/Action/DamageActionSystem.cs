...
namespace EGamePlay
{
        ...
        IAwake<DamageAction>
    {
        ...
        public static void Execute(DamageAction entity)
        {
            ...
            //伤害实际施效流程
            HealthSystem.ReceiveDamage(entity.Target, entity);

            EventSystem.Dispatch(new AfterCauseApplyCmd() { Entity = entity.Creator, Action = entity });
            EventSystem.Dispatch(new AfterReceiveApplyCmd() { Entity = entity.Target, Action = entity });

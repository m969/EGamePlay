...
namespace EGamePlay
{
        ...
        IAwake<CombatEntity, BehaviourPointComponent>
    {
        ...
        public static void AddListener(CombatEntity entity, ActionPointType actionPointType, Action<EcsEntity> action)
        {
        ...
        public static void RemoveListener(CombatEntity entity, ActionPointType actionPointType, Action<EcsEntity> action)
        {
            var component = entity.GetComponent<BehaviourPointComponent>();
            if (component.ActionPoints.ContainsKey(actionPointType))
            {
        ...
        public static void AddListener(CombatEntity entity, ApplyPointType applyPointType, Action<EcsEntity> action)
        {
            var component = entity.GetComponent<BehaviourPointComponent>();
        ...
        public static void RemoveListener(CombatEntity entity, ApplyPointType applyPointType, Action<EcsEntity> action)
        {
            var component = entity.GetComponent<BehaviourPointComponent>();
            if (component.ApplyPoints.ContainsKey(applyPointType))
            {
        ...
        public static void TriggerTargetApplyPoint(IActionExecute actionExecute, ApplyPointType pointType)
        {
            ...
            TriggerApplyPoint(actionExecute.Target as CombatEntity, pointType, (EcsEntity)actionExecute);
        }
        ...
        {
            if (actionExecute.Target.IsDisposed) return;
            TriggerActionPoint(actionExecute.Target as CombatEntity, pointType, (EcsEntity)actionExecute);
        }

...
namespace EGamePlay.Combat
{
    public partial class Ability : Entity
    {
        ...
        public override void Awake(object initData)
        {
            ...
            //if (Config.Type == "主动")
            //{
            //    ConfigObject.SkillSpellType = SkillSpellType.Initiative;
            //}
            //else if (Config.Type == "被动")
            //{
            //    ConfigObject.SkillSpellType = SkillSpellType.Passive;
            //}
            //else
            //{
            //    Log.Error($"技能类型错误 {Config.Type}");
            //}

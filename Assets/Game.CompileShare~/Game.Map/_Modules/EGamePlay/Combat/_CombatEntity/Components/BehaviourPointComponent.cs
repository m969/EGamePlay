...
namespace EGamePlay.Combat
{
    ...
    public sealed class BehaviourPoint
    {
        ...
        //public void AddListener(Action<EcsEntity> action)
        //{
        //    Listeners.Add(action);
        //}

        //public void RemoveListener(Action<EcsEntity> action)
        //{
        //    Listeners.Remove(action);
        //}

        //public void AddObserver(EcsEntity observer)
        //{
        //    Observers.Add(observer);
        //}

        //public void RemoveObserver(EcsEntity observer)
        //{
        //    Observers.Remove(observer);
        //}

        //public void TriggerAllObservers(EcsEntity actionExecution)
        //{

...
namespace EGamePlay.Combat
{
    ...
    {
        void OnTriggerApplyEffect(EcsEntity effectAssign);
    }
    ...
    public partial class AbilityEffect : EcsEntity
    {
        ...
        //    /// 施加状态效果
        //    if (this.EffectConfig is AddStatusEffect) AddComponent<EffectAddBuffComponent>();
        //    /// 自定义效果
        //    //if (this.EffectConfig is CustomEffect) AddComponent<EffectCustomComponent>();
        //    /// 效果修饰
        //    var decorators = this.EffectConfig.Decorators;
        //    if (decorators != null && decorators.Count > 0) AddComponent<EffectDecoratorComponent>();
        //}

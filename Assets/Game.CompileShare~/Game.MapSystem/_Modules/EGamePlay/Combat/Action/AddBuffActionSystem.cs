...
namespace EGamePlay
{
        ...
        IAwake<AddBuffAction>
    {
        ...
        public static void Execute(AddBuffAction entity)
        {
            ...
            if (canStack == false)
            {
                if (BuffSystem.HasStatus(entity.Target as CombatEntity, buffConfig.KeyName))
                {
                    var status = BuffSystem.GetStatus(entity.Target as CombatEntity, buffConfig.KeyName);
            ...
            entity.BuffAbility = BuffSystem.AttachStatus(entity.Target as CombatEntity, buffObject);
